...
foreach ($prefixRouters as $prefixRouter) {
    Route::prefix('horizontal-dark-menu')->group(function () {
        ...
        Route::prefix('master')->group(function () {
            ...
            // Route::get('/kapal/cport/getDetails/{id}', [\App\Http\Controllers\KapalController::class, 'getDetails'])->name('getDetails');
            Route::resource('/kapal', \App\Http\Controllers\CompanyPortController::class);
            Route::get('/kapal/cport/getDetails/{id}', [\App\Http\Controllers\CompanyPortController::class, 'getDetails'])->name('getDetails');
        ...
        Route::prefix('document')->group(function () {
            ...
            Route::get('/surat-pengantar', function () {
                return view('pages.abp-page.dsp', ['title' => 'Adhipramana Bahari Perkasa', 'breadcrumb' => 'This Breadcrumb']);
            })->name('surat-pengantar');
            Route::get('/surat-bap', function () {
                return view('pages.abp-page.dbap', ['title' => 'Adhipramana Bahari Perkasa', 'breadcrumb' => 'This Breadcrumb']);
            })->name('surat-bap');            
        });
