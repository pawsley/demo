...
<div class="header-container container-xxl">
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{getRouterValue();}}/dashboard/analytics">
                    ...
                    <img src="{{Vite::asset('resources/images/logo-abp.png')}}" class="navbar-logo logo-dark" alt="logo">
                    {{-- <img src="{{Vite::asset('resources/images/logo2.svg')}}" class="navbar-logo logo-light" alt="logo"> --}}
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{getRouterValue();}}/dashboard/analytics" class="nav-link"> Adhipramana Bahari Perkasa </a>
            </li>
        </ul>
        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
            ...
            <li class="nav-item theme-toggle-item" style="display: none;">
