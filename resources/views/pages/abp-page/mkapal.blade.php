                ...
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('kapal.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="select-beast" class="form-select" placeholder="Select a person..." autocomplete="off">
                                <option selected disabled value="">Pilih...</option>
                                @foreach ($compport as $cp)
                                    <option value="{{ $cp->id_company_port }}">{{ $cp->nama }}</option>
                                @endforeach
                            </select>
                            <select id="select-beast" placeholder="Select a person..." autocomplete="off" class="tomselected ts-hidden-accessible">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group has-validation">
                                <input name="no_telp" id="ph-number" type="text" class="form-control" placeholder="Masukkan no telepon" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input name="alamat_kpl" id="alamat" type="text" class="form-control" id="validationCustom03" placeholder="Masukkan alamat" required>
                            <div class="invalid-feedback">
