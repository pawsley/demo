                ...
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('customer.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan nama gudang" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group has-validation">
                                    <input name="no_cst" type="number" class="form-control" id="validationCustom04" placeholder="Masukkan nama kota gudang muat" required>
                                    <div class="invalid-feedback">
