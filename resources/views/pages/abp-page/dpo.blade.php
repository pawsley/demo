                ...
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('customer.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan PO Muat" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan PO Kebun" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <label for="validationCustom03" class="form-label">Items Description</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Masukkan Items"></textarea>
                        </div>
                        <div class="col-md-3">
                            <label for="validationCustom03" class="form-label">Quantity</label>
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Quantity" required>
                        </div>
                        <div class="col-md-3">
                            <label for="validationCustom03" class="form-label">Unit</label>
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Unit" required>
                        </div>
                        <div class="col-md-3">
                            <label for="validationCustom03" class="form-label">Unit Price (IDR)</label>
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Harga" required>
                        </div>
                        <div class="col-md-8">
                            <label for="validationCustom03" class="form-label">Amount (IDR)</label>
                            <input name="nama_cst" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Harga Total" required>
                        </div>
                        <div class="col-md-4">
