                ...
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('penerima.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nama_pen" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan nama perusahaan" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="grup_pen" class="form-select" id="validationDefault04" required>
                                <option selected disabled value="">Pilih...</option>
                                <option>None Group</option>
                                <option>MUSIMAS</option>
                                <option>BGA</option>
                                <option>MINAMAS</option>
                            </select>
                        </div>
                            <div class="col-md-4">
